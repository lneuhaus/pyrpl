...
pipeline {
    ...
    stages {
        ...
        stage('Notify github') { steps {
            githubNotify credentialsId: "b95d7179-1ff9-4b26-a1e0-c5f0123e3336", description: 'Jenkins has started...', status: 'PENDING', account: 'lneuhaus', repo: 'pyrpl', gitApiUrl: 'api.github.com'
        }}
