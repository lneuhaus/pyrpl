...
pipeline {
    ...
    stages {
        ...
        stage('Notify github') { steps {
            githubNotify description: 'Jenkins has started...', status: 'PENDING', account: 'lneuhaus', repo: 'pyrpl', gitApiUrl: 'https://api.github.com', credentialsId: 'jenkins-github-status'
        }}
