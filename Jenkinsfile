...
pipeline {
    ...
    stages {
        ...
        stage('Notify github') { steps {
            githubNotify credentialsId: 'jenkins-github-status', description: 'Jenkins has started...', status: 'PENDING', account: 'lneuhaus', repo: 'pyrpl', gitApiUrl: 'https://api.github.com'
        }}
