...
from .attributes import BaseAttribute, LongAttribute, PhaseAttribute, FloatAttribute, StringAttribute, BoolAttribute, \
                        SelectAttribute
...
class IntRegister(BaseRegister, BaseAttribute):
...
class LongRegister(BaseRegister, LongAttribute):
    ...
    def __init__(self, address, bits=64, **kwargs):
        ...
        LongAttribute.__init__(self, increment=1)
        self.bits = bits
...
class LongProperty(LongAttribute, BaseProperty):
    default = 0
